    ...
    <div class="col-lg-4 col-md-6 col-sm-8 mt-5 ml-auto mr-auto">
      <div class="card" style="margin-top: 120px;">
        <div class="card-header card-header-primary text-center">
          <h4 class="card-title">Bienvenue sur MaBank</h4>
        </div>
        <div class="card-body">
        <p class="card-description text-center">Authentification</p>
          <span class="bmd-form-group">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Numero d'identité bancaire" id="nib">
            </div>
          </span>
          <span class="bmd-form-group">
            <div class="input-group">
        ...
        <div class="card-footer">
          <a class="btn btn-link btn-default" href="<?= base_url("/Admin") ?>"><i class="fas fa-user-shield"></i></a>
