...
<nav class="navbar navbar-expand-lg bg-dark">
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
      <!--
      <li class="nav-item <?= ($content == "admin/list_page") ? "active" : "" ?>">
          <a class="nav-link" href="<?= base_url("/Admin/listClient") ?>">Liste des clients</a>
        </li>
      -->
        <li class="nav-item <?= ($content == "admin/admin_page") ? "active" : "" ?>">
          <a class="nav-link" href="<?= base_url("/Admin/home") ?>">Ajout d'un Client</a>
        </li>
        <li class="nav-item <?= ($content == "admin/search_page") ? "active" : "" ?>">
          <a class="nav-link" href="<?= base_url("/Admin/Search") ?>">Recherche d'un Client</a>
        </li>
        <li class="nav-item">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="text-align: center;">
        <a class="btn btn-primary" href="<?= base_url("/Admin/logout") ?>">Confirmer</a>
